...
public class PreguntaGroupChoiceTest {
    @Test
    public void test01Jugador1RespondeGCYSeLeAsignaUnPuntoPorHaberRespondidoBien() {
        //Arrange
    ...
    @Test
    public void test02Jugador1RespondeGCMalYNoSeLeAsignanPuntos() {
        //Arrange
        Opcion opcion1 = new OpcionCorrecta();
        Opcion opcion2 = new OpcionIncorrecta();
        Opcion opcion3 = new OpcionCorrecta();
    ...
    @Test
    public void test04JugadorRespondeBienPeroEnviaUnaListaDeOpcionesIncorrectasEsDecirGrupoDos() {
        //Arrange
        Opcion opcion1 = new OpcionCorrecta();
        Opcion opcion2 = new OpcionIncorrecta();
        Opcion opcion3 = new OpcionCorrecta();
        ...
        pregunta.agregarRespuestaDeJugador(jugador, respuestasGrupoDos);
        pregunta.agregarRespuestaDeJugador(jugador2, respuestasGrupoDos);
