...
public class PreguntaVerdaderoFalsoTest {
	...
	@Test
	public void test05UnJugadorActivaExclusividadDePuntajeYGanaElDobleDePuntosPorqueJugador2RespondeMal() {
		Opcion opcionVerdadero = new OpcionIncorrecta();
		Opcion opcionFalso = new OpcionCorrecta();
	...
	@Test
	public void test06DosJugadoresActivanExclusividadDePuntajeYGanaElCuadrupleDePuntosPorqueJugador2RespondeMal() {
		Opcion opcionVerdadero = new OpcionIncorrecta();
		Opcion opcionFalso = new OpcionCorrecta();
	...
	@Test
	public void test07DosJugadoresActivanExclusividadDePuntajeYRespondenAmbosBienEntoncesNoGananPuntos(){
		Opcion opcionVerdadero = new OpcionIncorrecta();
		Opcion opcionFalso = new OpcionCorrecta();
