...
public class SeleccionarOpcionGroupChoice implements EventHandler<ActionEvent> {
    ...
    public SeleccionarOpcionGroupChoice(Button botonOpcion, Button pasarAGrupo1, Button pasarAGrupo2, VBox grupo1, VBox grupo2, VBox grupoActual) {
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        pasarAGrupo1.setOnAction(new cambiarBotonDeContenedor(botonOpcion, grupoActual, grupo1));
        pasarAGrupo2.setOnAction(new cambiarBotonDeContenedor(botonOpcion, grupoActual, grupo2));
    }
}
