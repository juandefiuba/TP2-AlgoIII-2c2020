...
public class CambiarDeGrupoYDesmarcarComoElegida implements EventHandler<ActionEvent> {
    ...
    public CambiarDeGrupoYDesmarcarComoElegida(Kahoot kahoot, Button boton, Opcion opcion, VBox contenedorAntiguo, VBox contenedorNuevo, Button botonOk){
        this.kahoot = kahoot;
        this.opcion = opcion;
        this.boton = boton;
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        boton.setOnAction(new CambiarDeGrupoYMarcarComoElegida(kahoot, boton, opcion, contenedorAntiguo, contenedorNuevo, botonOk));
    }
}
