...
public class ContenedorPreguntaGroupChoice extends ContenedorPregunta {
    ...
    public ContenedorPreguntaGroupChoice(double segundos, String tipoDePregunta, Stage stage, Kahoot kahoot, boolean yaRespondioJugador, HBox botonesBonus, String rutaFondo, boolean seguirCancion) {
